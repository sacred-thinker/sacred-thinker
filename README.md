...
<li>RESTful API с корректными HTTP статусами</li>
<li>Swagger документация для всех endpoints</li>
<li>Docker контейнеризация с PostgreSQL</li>
<li>Структурированное логирование</li>
<li>Валидация данных</li>
<li>Пагинация и фильтрация списков</li>
</ul>
</div>
